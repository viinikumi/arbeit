...
const Vuorohaku = () => {
  ...
  return (
    <>
      <AppBar
        position="static"
        style={{ width: "350px", backgroundColor: "rgb(91, 91, 156)" }}
      >
        <Toolbar>
      ...
      <div className="ag-theme-material" style={{ height: 443, width: 350 }}>
        <AgGridReact
